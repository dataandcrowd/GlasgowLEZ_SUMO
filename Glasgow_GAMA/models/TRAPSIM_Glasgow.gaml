/**
* Name: TRAPsim
* Based on Traffic and Pollution. 
* Author: Hyesop Shin
* Tags: Air Pollution, Traffic
*/
...
//Shapefile of the buildings
	file building_shapefile <- file("../includes/LEZ_buildings.shp");
	//Shapefile of the roads
	file road_shapefile <- file("../includes/LEZ_road.shp");
...
experiment LEZtraffic type: gui autorun: false {
